...
sensor_thermostat::sensor_thermostat() : sensor_name("Qblox Temperature Sensor")
{
...
*
***********************************************************************************************************************/
sensor_thermostat::sensor_thermostat(std::string sensor_name) : sensor_name(sensor_name)
{
	
}
/**********************************************************************************************************************
* Member name: Parametrised constructor
* Arg: std::string sensor_name, unsigned int baud_rate, unsigned int node_address, unsigned int reg_address
* return -
* Description - Constructor of the temperature sensor that initialses with parameters such as name, node address,
* register address and the communication baud rate.
*
***********************************************************************************************************************/
sensor_thermostat::sensor_thermostat(std::string sensor_name, unsigned int baud_rate, unsigned int node_address, unsigned int reg_address) :  
                             sensor_name(sensor_name), baud_rate(baud_rate), node_address(node_address), reg_address(reg_address) 
